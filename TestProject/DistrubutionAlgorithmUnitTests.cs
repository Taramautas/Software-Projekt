...
namespace UnitTest.DistributionAlgorithm
{
    ...
    public class DistrubutionAlgorithmUnitTests
    {
        ...
        public void TestDistributionAlgorithm()
        {
            ...
            _bookingDao.Create(10, 80, new DateTime(2020, 7, 15, 12, 0, 0), new DateTime(2020, 7, 14, 13, 30, 0), veh1, userEmp, loc1, null, bookingdao_id);
            _bookingDao.Create(30, 90, new DateTime(2020, 7, 15, 12, 0, 0), new DateTime(2020, 7, 14, 13, 30, 0), veh1, userVip, loc1, null, bookingdao_id);
            ...
            Uebungsprojekt.DistributionAlgorithm.DistributionAlg(_chargingcolumndao, _locationDao, _bookingDao);
