...
namespace UnitTest.DistributionAlgorithm
{
    ...
    public class DistrubutionAlgorithmUnitTests
    {
        ...
        public void TestDistributionAlgorithm()
        {
            ...
            int cct_id3 = _chargingColumnTypeDao.Create("DC Ladestation", "Delta", 40, new List<ConnectorType> { ConnectorType.Tesla_Supercharger, ConnectorType.Type_1_Plug });
            int cct_id4 = _chargingColumnTypeDao.Create("Evlink", "Schneider Electric", 70, new List<ConnectorType> { ConnectorType.Schuko_Socket, ConnectorType.Type_2_Plug, ConnectorType.Tesla_Supercharger });
            ...
            int charcol_id3 = _chargingcolumndao.Create(cct3, false, false, cz1, new List<Tuple<DateTime, DateTime>>(), charcoldao_id);
            int charcol_id4 = _chargingcolumndao.Create(cct4, false, false, cz1, new List<Tuple<DateTime, DateTime>>(), charcoldao_id);
            ...
            int veh3_id = _vehicleDao.Create("VW", 58, new List<ConnectorType> { ConnectorType.Schuko_Socket, ConnectorType.CHAdeMO_Plug });
            ...
            _bookingDao.Create(10, 80, new DateTime(2020, 7, 15, 9, 0, 0), new DateTime(2020, 7, 15, 10, 30, 0), veh3, userEmp, loc1, null, bookingdao_id);
