...
namespace ListsUnitTests
{
    public class Tests
    {
        ...
        public void TestFindUnacceptedBookings()
        {
            ...
            int bId1 = _bookingDao.Create(10, 80, new DateTime(2020, 7, 4, 12, 0, 0), new DateTime(2020, 7, 4, 15, 0, 0), false, new Vehicle(), _userDao.GetById(user_id1), new Location(), new ChargingColumn(), id); //Emp
            int bId2 = _bookingDao.Create(20, 80, new DateTime(2020, 7, 4, 12, 0, 0), new DateTime(2020, 7, 4, 15, 0, 0), true, new Vehicle(), _userDao.GetById(user_id2), new Location(), new ChargingColumn(), id); //Guest
            int bId3 = _bookingDao.Create(30, 80, new DateTime(2020, 7, 4, 12, 0, 0), new DateTime(2020, 7, 4, 15, 0, 0), true, new Vehicle(), _userDao.GetById(user_id3), new Location(), new ChargingColumn(), id); //VIP
            int bId4 = _bookingDao.Create(40, 80, new DateTime(2020, 7, 4, 12, 0, 0), new DateTime(2020, 7, 4, 15, 0, 0), false, new Vehicle(), _userDao.GetById(user_id4), new Location(), new ChargingColumn(), id); //Guest
            int bId5 = _bookingDao.Create(50, 80, new DateTime(2020, 7, 4, 12, 0, 0), new DateTime(2020, 7, 4, 15, 0, 0), false, new Vehicle(), _userDao.GetById(user_id5), new Location(), new ChargingColumn(), id); //Emp
            int bId6 = _bookingDao.Create(60, 80, new DateTime(2020, 7, 4, 12, 0, 0), new DateTime(2020, 7, 4, 15, 0, 0), false, new Vehicle(), _userDao.GetById(user_id6), new Location(), new ChargingColumn(), id); //VIP
        ...
        public void TestListOfBookingLocations()
        {
            ...
            _bookingDao.Create(10, 80, new DateTime(2020, 7, 4, 12, 0, 0), new DateTime(2020, 7, 4, 15, 0, 0), false, new Vehicle(), new User(), _locationDao.GetById(loc_id1, locationdao_id), new ChargingColumn(), bookingdao_id);
            _bookingDao.Create(20, 80, new DateTime(2020, 7, 4, 12, 0, 0), new DateTime(2020, 7, 4, 15, 0, 0), false, new Vehicle(), new User(), _locationDao.GetById(loc_id1, locationdao_id), new ChargingColumn(), bookingdao_id);
            _bookingDao.Create(30, 80, new DateTime(2020, 7, 4, 12, 0, 0), new DateTime(2020, 7, 4, 15, 0, 0), false, new Vehicle(), new User(), _locationDao.GetById(loc_id2, locationdao_id), new ChargingColumn(), bookingdao_id);
            _bookingDao.Create(40, 80, new DateTime(2020, 7, 4, 12, 0, 0), new DateTime(2020, 7, 4, 15, 0, 0), false, new Vehicle(), new User(), _locationDao.GetById(loc_id3, locationdao_id), new ChargingColumn(), bookingdao_id);
            _bookingDao.Create(50, 80, new DateTime(2020, 7, 4, 12, 0, 0), new DateTime(2020, 7, 4, 15, 0, 0), false, new Vehicle(), new User(), _locationDao.GetById(loc_id1, locationdao_id), new ChargingColumn(), bookingdao_id);
        ...
        public void TestListofBookingChargingColumn()
        {
            ...
            int cct_id1 = _chargingColumnTypeDao.Create(30, "McDonalds", new List<ConnectorType> { ConnectorType.CCS_Combo_2_Plug, ConnectorType.Tesla_Supercharger, ConnectorType.Type_1_Plug });
            int cct_id2 = _chargingColumnTypeDao.Create(40, "BurgerKing", new List<ConnectorType> { ConnectorType.CCS_Combo_2_Plug, ConnectorType.Type_2_Plug, ConnectorType.CHAdeMO_Plug });
            int cct_id3 = _chargingColumnTypeDao.Create(35, "KFC", new List<ConnectorType> { ConnectorType.Type_2_Plug });
            ...
            int bId1 = _bookingDao.Create(10, 80, new DateTime(2020, 7, 4, 12, 0, 0), new DateTime(2020, 7, 4, 15, 0, 0), false, _vehicleDao.GetById(veh_id1), new User(), _chargingcolumndao.GetById(charcol_id1, charcoldao_id).charging_zone.location, _chargingcolumndao.GetById(charcol_id1, charcoldao_id), bookingDaoId);
            int bId2 = _bookingDao.Create(10, 80, new DateTime(2020, 7, 4, 12, 0, 0), new DateTime(2020, 7, 4, 15, 0, 0), false, _vehicleDao.GetById(veh_id1), new User(), _chargingcolumndao.GetById(charcol_id2, charcoldao_id).charging_zone.location, _chargingcolumndao.GetById(charcol_id2, charcoldao_id), bookingDaoId);
            int bId3 = _bookingDao.Create(10, 80, new DateTime(2020, 7, 4, 12, 0, 0), new DateTime(2020, 7, 4, 15, 0, 0), false, _vehicleDao.GetById(veh_id3), new User(), _chargingcolumndao.GetById(charcol_id3, charcoldao_id).charging_zone.location, _chargingcolumndao.GetById(charcol_id3, charcoldao_id), bookingDaoId);
            int bId4 = _bookingDao.Create(10, 80, new DateTime(2020, 7, 4, 12, 0, 0), new DateTime(2020, 7, 4, 15, 0, 0), false, _vehicleDao.GetById(veh_id2), new User(), _chargingcolumndao.GetById(charcol_id2, charcoldao_id).charging_zone.location, _chargingcolumndao.GetById(charcol_id2, charcoldao_id), bookingDaoId);
            int bId5 = _bookingDao.Create(10, 80, new DateTime(2020, 7, 4, 12, 0, 0), new DateTime(2020, 7, 4, 15, 0, 0), false, _vehicleDao.GetById(veh_id3), new User(), _chargingcolumndao.GetById(charcol_id5, charcoldao_id).charging_zone.location, _chargingcolumndao.GetById(charcol_id5, charcoldao_id), bookingDaoId);
            int bId6 = _bookingDao.Create(10, 80, new DateTime(2020, 7, 4, 12, 0, 0), new DateTime(2020, 7, 4, 15, 0, 0), false, _vehicleDao.GetById(veh_id1), new User(), _chargingcolumndao.GetById(charcol_id6, charcoldao_id).charging_zone.location, _chargingcolumndao.GetById(charcol_id6, charcoldao_id), bookingDaoId);
            int bId7 = _bookingDao.Create(10, 80, new DateTime(2020, 7, 4, 12, 0, 0), new DateTime(2020, 7, 4, 15, 0, 0), false, _vehicleDao.GetById(veh_id2), new User(), _chargingcolumndao.GetById(charcol_id4, charcoldao_id).charging_zone.location, _chargingcolumndao.GetById(charcol_id4, charcoldao_id), bookingDaoId);
